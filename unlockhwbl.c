...
DLLImport void * __fastcall CodeInit(void *);
DLLImport uint8_t __fastcall UpdateCode(void *);
DLLImport void __fastcall CodeExit(void *);
void main(void){
    struct{
        uint8_t head[22];
        uint16_t code[16];
                        ...
                        if(data=='K'){
                            ...
                            if(data=='A'){
                                ...
                                if(data=='Y'){
                                    ...
                                    WriteFile(stdo,"Unlocked,Now Wait For fastboot Exit...",38,&temp,0);
